    ...
    for epoch in range(num_epochs):
        ...
        for features, labels in train_loader:
            ...
            if (total_step+1) % 2000 == 0:
                ...
                torch.save(model.state_dict(), f'models/dnn_focal/model_epoch_{epoch}_{total_step}.pth')
                model.train()
        torch.save(model.state_dict(), f'models/dnn_focal/model_epoch_{epoch}.pth')    
