...
--********************************************************************--
--author:zhng25
--create time:2025-02-12 11:17:51
--********************************************************************--
create table if not exists user_pay_sample_feature_join_dnn_eval(
    user_id string,
    brand_id string,
    label bigint,
...
insert OVERWRITE TABLE user_pay_sample_feature_join_dnn_eval partition (ds=${bizdate})
...
--select count(*) from user_pay_sample_feature_join_dnn_eval where ds=${bizdate} and label=0 ;

create table if not exists user_pay_sample_feature_join_eval_dnn_seq(
    key_all string,
    label bigint,
    target_brand_id string,
    click_brand_seq string,
...
insert OVERWRITE TABLE user_pay_sample_feature_join_eval_dnn_seq
select t1.brand_id as key_all, t1.label, t1.number,
...
--select * from user_pay_sample_feature_join_eval_dnn_seq limit 1000;
select count(*) from user_pay_sample_feature_join_eval_dnn_seq;
